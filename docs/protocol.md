        # Mapriors: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/MAPriors.git

        ## Objective

        MAPriors implements the Meta-Analytic Prior approach, synthesising historical data into informative Bayesian priors for use in prospective trials and new meta-analyses.
        ...
        - Code: https://github.com/mahmood726-cyber/MAPriors.git
